export default {
  ...
  settings: {
    ...
    platformMcp: 'Platform MCP Service',
  ...
  webSearchSettings: {
    ...
    platformTitle: 'Platform Web Search Configuration',
    platformDescription: 'Manage the web search provider set maintained by the platform administrator in the current tenant context.',
  ...
  auth: {
    ...
    registerSubtitle: 'Enter a tenant ID to join an existing tenant, or leave it blank to create a new tenant and become its owner',
    emailPlaceholder: 'Enter email address',
    tenantIdOptional: 'Tenant ID (Optional)',
    tenantIdPlaceholder: 'Enter an existing tenant ID, or leave blank to create a new tenant',
    tenantIdHint: 'Provide a tenant ID to join an existing tenant. Leave it blank to create your own tenant and become its owner.',
...
\
  ...
  mcpSettings: {
    ...
    platformTitle: 'Platform MCP Services',
    platformDescription: 'Manage the MCP service set maintained by the platform administrator in the current tenant context.',
  ...
  modelSettings: {
    ...
    platformTitle: 'Platform Model Settings',
    platformDescription: 'Manage platform-shared infrastructure models available to tenants.',
    actions: {
      addModel: 'Add Model',
    ...
    toasts: {
      ...
      sharedCannotEdit: 'Platform models can only be edited by super-admins',
      sharedCannotDelete: 'Platform models can only be deleted by super-admins',
    },
    platformTag: 'Platform',
