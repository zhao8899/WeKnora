export default {
  ...
  knowledgeBase: {
    ...
    failedDocsBannerText: '{count} document(s) failed to parse. Please check the file format and retry.',
    retryAllFailed: 'Retry all failed documents',
    retryAllSubmitted: 'Submitted re-parsing for {count} document(s)',
    selectedCount: '{count} selected',
    batchDelete: 'Delete Selected',
    batchDeleteConfirmTitle: 'Delete Documents',
    batchDeleteConfirmBody: 'Delete {count} selected document(s)? This cannot be undone.',
    batchDeleteSuccess: 'Deleted {count} document(s)',
    batchDeleteFailed: 'Batch delete failed. Please try again.',
    parsingQueued: 'Queued...',
  ...
  agent: {
    ...
    sectionBuiltin: 'Platform Built-in',
    sectionMine: 'Mine',
    template: {
      title: 'Choose a starting point',
      desc: 'Pick a template to get started quickly, or build from scratch',
  ...
  settings: {
    ...
    health: {
      ...
      subtitle: 'Track answer coverage, source freshness, and document citation activity without leaving the settings page.',
      refresh: 'Refresh',
      pendingKnowledgeQuestions: 'Pending Knowledge Questions',
      pendingKnowledgeStatus: 'Need knowledge update',
      draftKnowledgeBase: 'Draft KB',
      createDraft: 'Create Draft',
      selectKnowledgeBaseFirst: 'Select a target knowledge base first',
      draftCreated: 'Draft created',
      draftCreateFailed: 'Failed to create draft',
      hotQuestions: 'Hot Questions',
      coverageGaps: 'Coverage Gaps',
      staleDocuments: 'Stale Documents',
      citationHeatmap: 'Citation Heatmap',
      ...
      downFeedback: 'Down Feedback',
      status: 'Status',
      needsReview: 'Needs Review',
      normal: 'Normal',
      healthy: 'Healthy',
      copyQuestion: 'Copy Question',
      copySuccess: 'Question copied',
    },
    evaluation: {
      title: 'Evaluation',
      subtitle: 'Run trial evaluations and review retrieval and generation metrics before launch.',
      run: 'Run evaluation',
      loadTask: 'Load task',
      formTitle: 'Evaluation inputs',
      taskTitle: 'Evaluation result',
      datasetId: 'Dataset ID',
      knowledgeBaseId: 'Knowledge base ID (optional)',
      chatModelId: 'Chat model ID (optional)',
      rerankModelId: 'Rerank model ID (optional)',
      taskId: 'Task ID',
      taskIdPlaceholder: 'Enter a task ID to load results',
      datasetIdPlaceholder: 'default or a custom dataset',
      knowledgeBaseIdPlaceholder: 'Leave empty to create a temporary knowledge base',
      chatModelIdPlaceholder: 'Leave empty to use the default QA model',
      rerankModelIdPlaceholder: 'Leave empty to use the default rerank model',
      progress: 'Progress',
      startTime: 'Start time',
      error: 'Error',
      noResult: 'No evaluation result yet',
      ...
      failed: 'Failed',
      pending: 'Pending',
      loadFailed: 'Failed to load evaluation result',
      datasetRequired: 'Please enter a dataset ID first',
      started: 'Evaluation started',
      runFailed: 'Failed to start evaluation',
    },
  ...
  webSearchSettings: {
    ...
    platformSharedLabel: 'Platform Shared',
    platformSharedTag: 'Platform',
    testConnection: 'Test Connection',
    testing: 'Testing...',
    free: 'Free',
    ...
    platformSharedDesc: 'Visible to all tenants and can be used as the platform default search provider.',
    // Search behavior
  ...
  input: {
    ...
    notConfigured: 'Not configured',
    platformModel: 'Platform model ({name})',
    ...
    modeSummaryTrustedQa: 'This answer will stay grounded in the selected knowledge and cited sources.',
    modeSummaryDeepResearch: 'This answer may use tools, web search, and multi-step reasoning before replying.',
    modeSummaryCustomAgent: '{name} will answer using its configured tools and knowledge scope.',
    capabilityKnowledgeOn: 'Knowledge on',
    capabilityKnowledgeOff: 'Knowledge off',
    capabilityWebOn: 'Web on',
    capabilityWebOff: 'Web off',
    capabilityToolsOn: 'Tools on',
    capabilityToolsOff: 'Tools off',
    capabilityMemoryOn: 'Memory on',
    capabilityMemoryOff: 'Memory off',
    messages: {
...
\
  ...
  chat: {
    ...
    suggestedQuestionsHint: 'Click a question to start the conversation',
    ...
    sourceHealthHigh: 'Healthy sources',
    sourceHealthMedium: 'Mixed source health',
    sourceHealthLow: 'Weak source health',
    sourceHealthInsufficient: 'Source health unknown',
    feedbackExpired: 'Mark as expired',
    feedbackExpiredHint: 'This source is outdated — helps the system reduce its weight',
    noConfidenceEvidence: 'No evidence details yet',
    noConfidenceEvidenceYet: 'References are available, but evidence details are still being generated',
    noConfidenceEvidenceDegraded: 'Evidence details are temporarily unavailable; showing a degraded confidence view',
    confidenceLoadFailed: 'Failed to load evidence panel',
    evidenceRecovered: '{count} sources recovered from references',
    evidenceDegraded: '{count} transient sources',
    sourceFeedbackSuccess: 'Source feedback recorded',
    sourceFeedbackFailed: 'Failed to submit source feedback',
    sourceTypeDocument: 'Document',
    sourceTypeFaq: 'FAQ',
    sourceTypeWeb: 'Web',
    matchTypeVector: 'Vector recall',
    matchTypeKeyword: 'Keyword match',
    matchTypeNearby: 'Nearby chunk',
    matchTypeHistory: 'History context',
    matchTypeGraph: 'Graph match',
    matchTypeWebSearch: 'Web search',
    matchTypeDataAnalysis: 'Data analysis',
    ...
    followUpQuestionsHint: 'Suggested questions based on this answer',
  },
  tenant: {
  ...
  model: {
    ...
    editor: {
      ...
      isBuiltinLabel: 'Platform-wide Model',
      isBuiltinDesc: 'When enabled, this model is shared with all tenants as a platform default',
  ...
  agentSettings: {
    ...
    advancedParams: {
      label: 'Advanced Inference Parameters',
      desc: 'Fine-tune model generation behavior. Leave blank to use system defaults.',
      topP: {
        label: 'Top P (Nucleus Sampling)',
        desc: 'Limit token sampling to the top P cumulative probability mass. Works with temperature to control diversity. 0 = disabled.',
      },
      llmCallTimeout: {
        label: 'LLM Call Timeout',
        desc: 'Maximum wait time per LLM call (seconds). Auto-retries on timeout. Default: 120s.',
        unit: 'sec',
      },
      maxContextTokens: {
        label: 'Max Context Tokens',
        desc: 'Token budget for the agent context window. Older messages are compressed when exceeded. Default: 200000.',
      },
      maxToolOutputChars: {
        label: 'Tool Output Truncation',
        desc: 'Maximum characters returned per tool call. Excess is truncated. Default: 16000.',
        unit: 'chars',
      },
      parallelToolCalls: {
        label: 'Parallel Tool Calls',
        desc: 'Execute independent tool calls concurrently to reduce total wait time.',
      },
    },
    allowedTools: {
      label: 'Allowed Tools',
  ...
  chatSurface: {
    searchLabel: 'Knowledge Search',
    searchDesc: 'Browse chunks and message history without opening a chat thread',
    trustedQaLabel: 'Trusted Q&A',
    trustedQaDesc: 'Use the knowledge base and citations for grounded answers',
    deepResearchLabel: 'Deep Research',
    deepResearchDesc: 'Use multi-step reasoning, tools, web search, and memory',
  },
  knowledgeSearch: {
    title: 'Search',
  ...
  agentEditor: {
    ...
    desc: {
      ...
      topP: 'Nucleus sampling: limit token selection to top P cumulative probability. 0 = disabled',
      llmCallTimeout: 'Max seconds to wait for a single LLM response. Auto-retries on timeout.',
      maxContextTokens: 'Token budget for the agent context window. Older messages are compressed when exceeded.',
      maxToolOutputChars: 'Max characters returned per tool call. Excess is truncated.',
      parallelToolCalls: 'Execute independent tool calls concurrently to reduce total wait time.',
  ...
  datasource: {
    ...
    resourceHint: 'Select the resources to sync',
    ...
    connectorDesc: {
      ...
      web_crawler: 'Crawl pages from a website URL list or sitemap',
      rss: 'Sync articles from RSS or Atom feeds',
    ...
    fieldHint: {
      pageUrls: 'One URL per line, for example https://example.com/docs',
      feedUrls: 'One feed URL per line, for example https://example.com/feed.xml',
    },
    multilineHint: 'Enter one URL per line. Commas are also supported.',
    storageWarningTitle: 'Storage engine required',
    storageWarningDesc: 'This knowledge base has not selected a storage engine yet. Configure storage before creating or syncing a data source.',
    storageRequired: 'Configure a storage engine for this knowledge base before creating or syncing a data source.',
    summaryLabel: 'Source scope',
    deletionModeLabel: 'Deletion sync',
    deletionMode: {
      sync: 'Archive deleted source items',
      ignore: 'Ignore source deletions',
    },
    summary: {
      notConfigured: 'Not configured yet',
      resources: '{count} selected resources',
      rssFeeds: '{count} feed URLs',
      webUrls: '{count} page URLs',
      webSitemap: 'Sitemap crawl enabled',
      webMixed: '{count} page URLs + sitemap',
    },
    issue: {
      config: 'Configuration issue',
      sync: 'Sync issue',
    },
    latestRunDetails: 'Latest run details',
    showRunDetails: 'Show latest run',
    hideRunDetails: 'Hide latest run',
    latestErrors: 'Recent errors',
    noRecentErrors: 'No recent errors',
    manualActionRequired: 'Needs attention',
    manualAction: {
      storage: 'Storage engine not configured',
      feeds: 'Feed list is incomplete',
      pages: 'Crawl scope is incomplete',
      auth: 'Source access needs authorization',
      missing: 'Source address needs verification',
      network: 'Temporary network failure',
      format: 'Source format is unsupported',
      config: 'Datasource configuration is invalid',
      retry: 'Needs manual review',
    },
    manualHint: {
      storage: 'Configure the knowledge base storage engine first, then retry sync.',
      feeds: 'Add valid feed URLs and test the connection again.',
      pages: 'Add page URLs or a sitemap, then test the connection again.',
      auth: 'Check the source credentials, permissions, or upstream access policy.',
      missing: 'Confirm the source URL still exists and is reachable.',
      network: 'Retry later or check whether the source site is temporarily unavailable.',
      format: 'The upstream content is not a valid feed or supported page response.',
      config: 'Review the datasource fields and save a corrected configuration.',
      retry: 'Open sync logs to inspect the exact upstream error before retrying.',
    },
    syncBlocked: {
      storage: 'Configure the knowledge base storage engine before syncing.',
      feeds: 'Complete the feed list before syncing.',
      pages: 'Complete the crawl scope before syncing.',
      auth: 'Fix datasource authorization before syncing.',
      format: 'Adjust the source format or URL before syncing.',
      config: 'Fix datasource configuration before syncing.',
    },
    fixBeforeSync: 'Fix before sync',
    viewLogs: 'View logs',
    ...
    noResourcesDesc_web_crawler: 'No crawlable pages were found. Check the URLs or sitemap and retry.',
    noResourcesDesc_rss: 'No feed entries were found. Check the feed URL and retry.',
    guideStep1_web_crawler: 'Provide one or more page URLs, or a sitemap URL.',
    guideStep2_web_crawler: 'Use public pages that can be fetched from the server.',
    guideStep3_web_crawler: 'Retry after checking the URL format and site accessibility.',
    guideStep1_rss: 'Provide one or more valid RSS or Atom feed URLs.',
    guideStep2_rss: 'Make sure the feed is publicly accessible and returns XML.',
    guideStep3_rss: 'Retry after checking the feed address or validator output.',
