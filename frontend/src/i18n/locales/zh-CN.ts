export default {
  ...
  webSearchSettings: {
    ...
    platformTitle: "平台网络搜索配置",
    platformDescription: "管理当前租户上下文中由超级管理员维护的平台基础网络搜索配置。",
  ...
  auth: {
    ...
    registerSubtitle: "可填写租户ID加入已有租户；不填写则自动创建新租户并成为管理员",
    emailPlaceholder: "输入邮箱地址",
    tenantIdOptional: "租户ID（可选）",
    tenantIdPlaceholder: "填写已有租户ID，留空则自动创建新租户",
    tenantIdHint: "加入已有租户时请输入租户ID；留空表示自建租户并成为该租户管理员。",
    tenantIdInvalid: "租户ID必须是大于 0 的整数",
  ...
  mcpSettings: {
    ...
    platformTitle: "平台 MCP 服务管理",
    platformDescription: "管理当前租户上下文中由超级管理员维护的平台基础 MCP 服务配置。",
  ...
  modelSettings: {
    ...
    platformTitle: "平台模型配置",
    platformDescription: "管理可供租户选择的平台共享基础模型。",
    actions: {
      addModel: "添加模型",
      setDefault: "设为默认",
    },
    ...
    toasts: {
      ...
      sharedCannotEdit: "平台模型仅超级管理员可编辑",
      sharedCannotDelete: "平台模型仅超级管理员可删除",
    },
    platformTag: "平台",
