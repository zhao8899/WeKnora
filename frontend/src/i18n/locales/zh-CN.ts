export default {
  ...
  batchManage: {
    ...
    cancel: "取消",
    delete: "删除问答记录",
    deleteConfirmTitle: "删除问答记录",
    deleteConfirmBody: "确定要删除选中的 {count} 条问答记录吗？删除后无法恢复。",
    deleteAllConfirmBody: "确定要删除所有问答记录吗？此操作无法恢复。",
    deleteSuccess: "删除成功",
    deleteFailed: "删除失败，请稍后再试",
    noSelection: "请至少选择一条问答记录",
    loadFailed: "加载问答记录失败",
  },
  listSpaceSidebar: {
    title: "筛选",
  ...
  knowledgeBase: {
    ...
    moveProgress: "正在移动...",
    parsingFailed: "解析失败",
    failedDocsBannerText: "{count} 个文档解析失败，请检查文件格式后重新解析。",
    retryAllFailed: "重新解析全部失败文档",
    retryAllSubmitted: "已提交重新解析 {count} 个文档",
    selectedCount: "已选 {count} 项",
    batchDelete: "批量删除",
    batchDeleteConfirmTitle: "批量删除文档",
    batchDeleteConfirmBody: "确定要删除选中的 {count} 个文档吗？此操作不可撤销。",
    ...
    sessionCreationFailed: "创建问答失败",
    sessionCreationError: "问答创建错误",
  ...
  chat: {
    title: "智能问答",
    newChat: "新问答",
    suggestedQuestions: "你可以这样提问",
    suggestedQuestionsHint: "点击问题可直接开始对话",
    ...
    answerConfidence: "回答置信度",
    confidenceHigh: "高置信",
    confidenceMedium: "中置信",
    confidenceLow: "低置信",
    confidenceInsufficient: "证据不足",
    feedbackExpired: "标记过期",
    feedbackExpiredHint: "此来源内容已过期，帮助系统降低其权重",
    noConfidenceEvidence: "暂无证据明细",
    confidenceLoadFailed: "加载证据面板失败",
    sourceFeedbackSuccess: "已记录来源反馈",
    sourceFeedbackFailed: "来源反馈提交失败",
    sourceTypeDocument: "文档",
    sourceTypeFaq: "FAQ",
    sourceTypeWeb: "网页",
    matchTypeVector: "向量召回",
    matchTypeKeyword: "关键词匹配",
    matchTypeNearby: "邻近片段",
    matchTypeHistory: "历史上下文",
    matchTypeGraph: "图谱匹配",
    matchTypeWebSearch: "网页搜索",
    matchTypeDataAnalysis: "数据分析",
    retrievalScore: "检索分",
    channelWeb: "网页",
    channelApi: "API",
    channelIm: "IM",
    ...
    followUpQuestions: "继续追问",
    followUpQuestionsHint: "基于本次回答的推荐问题",
  },
  settings: {
    title: "设置",
    modelConfig: "模型配置",
    ...
    health: {
      title: "知识健康",
      subtitle: "在设置页查看问答覆盖、来源新鲜度和文档引用热度。",
      refresh: "刷新",
      pendingKnowledgeQuestions: "待补知识问题",
      pendingKnowledgeStatus: "需要补充知识",
      draftKnowledgeBase: "草稿知识库",
      createDraft: "创建草稿",
      selectKnowledgeBaseFirst: "请先选择目标知识库",
      draftCreated: "草稿已创建",
      draftCreateFailed: "创建草稿失败",
      hotQuestions: "热点问题",
      coverageGaps: "覆盖空白",
      staleDocuments: "陈旧文档",
      citationHeatmap: "引用热力图",
      empty: "暂无分析数据",
      question: "问题",
      retrievedCount: "检索数",
      rerankedCount: "重排数",
    ...
    evaluation: {
      title: "评测",
      subtitle: "发起试点评测并查看检索与生成指标，作为上线前验收入口。",
      run: "发起评测",
      loadTask: "加载任务",
      formTitle: "评测参数",
      taskTitle: "评测结果",
      ...
      chatModelId: "Chat 模型 ID（可选）",
      rerankModelId: "Rerank 模型 ID（可选）",
      taskId: "任务 ID",
      taskIdPlaceholder: "输入任务 ID 查看结果",
      datasetIdPlaceholder: "default 或自定义数据集",
      knowledgeBaseIdPlaceholder: "留空则自动创建临时知识库",
      chatModelIdPlaceholder: "留空使用默认知识问答模型",
      rerankModelIdPlaceholder: "留空使用默认重排模型",
      progress: "进度",
      startTime: "开始时间",
      error: "错误",
      noResult: "暂无任务结果",
  ...
  webSearchSettings: {
    ...
    setAsDefault: "设为默认",
    platformSharedLabel: "平台共享",
    platformSharedTag: "平台",
    testConnection: "测试连接",
    testing: "测试中...",
    free: "免费",
    viewDocs: "查看文档获取密钥",
    ...
    platformSharedDesc: "对所有租户可见，并可作为平台默认搜索引擎。",
    // Search behavior
  ...
  auth: {
    ...
    forgotPasswordNotAvailable: "密码找回功能暂不可用，请联系平台超级管理员",
  },
  authStore: {
    errors: {
  ...
  knowledgeList: {
    ...
    subtitle: "集中维护企业知识内容，支持文档型和 FAQ 型知识库",
    myKnowledgeBases: "我的知识库",
    ...
    emptyShared: "当前还没有共享给你的知识库，可以加入共享空间或联系空间负责人分配访问权限",
    empty: {
      title: "暂无知识库",
      description: "当前还没有知识库内容，可以先创建一个文档知识库或 FAQ 知识库开始试点建设",
      sharedTitle: "暂无共享知识库",
      sharedDescription: "当前空间还没有共享知识库，可以先共享试点内容或联系空间负责人补充知识",
      ask: "先去提问",
      goSpace: "查看共享空间",
    },
    delete: {
  ...
  input: {
    addModel: "添加模型",
    placeholder: "输入你的问题",
    placeholderWithContext: "输入问题，将基于上方选中的知识库/文件进行问答",
    placeholderWebOnly: "输入问题，将结合网络搜索进行问答",
    placeholderKbAndWeb: "输入问题，将基于知识库和网络搜索进行问答",
    placeholderAgent: "向 {name} 发起问答",
    agentMode: "智能推理",
    normalMode: "快速问答",
    normalModeDesc: "基于知识库的 RAG 问答",
    agentModeDesc: "多步思考，深度分析",
    agentNotReadyTooltip: "当前问答模式未就绪，请先在设置中完成配置",
    agentMissingAllowedTools: "允许的工具",
    agentMissingSummaryModel: "对话模型（Summary Model）",
    agentMissingRerankModel: "重排模型（Rerank Model）",
    goToSettings: "前往设置 →",
    customAgentNotReadyTooltip: "当前问答助手未就绪，请先完成配置",
    customAgentNotReadyDetail: "当前问答助手未就绪，需要配置以下内容：{reasons}",
    customAgentMissingSummaryModel: "对话模型（Summary Model）",
    customAgentMissingRerankModel: "重排模型（Rerank Model）",
    goToAgentEditor: "前往配置 →",
    agentNotReadyDetail: "问答助手「{agentName}」未就绪，需要配置以下内容：{reasons}",
    builtinAgentNotReadyDetail: "内置问答助手「{agentName}」未就绪，需要配置以下内容：{reasons}",
    ...
    notConfigured: "未配置",
    platformModel: "平台模型（{name}）",
    sharedAgentModelLabel: "共享问答助手配置的模型",
    model: "模型",
    remote: "远程",
    noModel: "暂无可用模型",
    stopGeneration: "停止生成",
    ...
    modeSummaryTrustedQa: "当前会优先基于已选知识和引用证据进行回答。",
    modeSummaryDeepResearch: "当前会在回答前使用工具、网络搜索和多步推理。",
    modeSummaryCustomAgent: "{name} 将按自身配置的工具和知识范围进行回答。",
    capabilityKnowledgeOn: "知识已启用",
    capabilityKnowledgeOff: "知识未启用",
    capabilityWebOn: "网络已启用",
    capabilityWebOff: "网络未启用",
    capabilityToolsOn: "工具已启用",
    capabilityToolsOff: "工具未启用",
    capabilityMemoryOn: "记忆已启用",
    capabilityMemoryOff: "记忆未启用",
    messages: {
      enterContent: "请先输入内容!",
      ...
      agentSelected: "已选择问答助手「{name}」",
      agentEnabled: "智能推理已启用",
      agentDisabled: "智能推理已禁用",
      agentNotReadyDetail:
        "当前问答模式未就绪，需要配置以下内容：{reasons}",
      webSearchNotConfigured:
        "未配置网络搜索引擎，请先在设置中完成搜索引擎选择与接口配置。",
      webSearchEnabled: "网络搜索已开启",
      webSearchDisabled: "网络搜索已关闭",
      sessionMissing: "问答记录 ID 不存在",
      messageMissing: "无法获取消息 ID，请刷新页面后重试",
      stopSuccess: "已停止生成",
      stopFailed: "停止失败，请重试",
    },
    webSearchDisabledByAgent: "当前问答助手已禁用网络搜索",
    webSearchForcedByAgent: "当前问答助手已启用网络搜索，无法关闭",
    kbLockedByAgent: "当前问答助手已锁定知识库配置",
    kbDisabledByAgent: "当前问答助手已禁用知识库功能",
    cannotRemoveAgentKb: "问答助手配置的知识库无法移除",
    agentConfiguredKb: "由问答助手配置，不可删除",
    modelLockedByAgent: "当前问答助手已锁定模型配置",
    imageUploadDisabledByAgent: "当前问答助手未启用图片上传",
    goToAgentSettings: "去设置问答助手",
  },
  agentSettings: {
    title: "Agent 配置",
    description:
    ...
    advancedParams: {
      label: "高级推理参数",
      desc: "精细调整模型生成行为，留空则使用系统默认值",
      topP: {
        label: "Top P（核采样）",
        desc: "限制模型从累积概率前 P 的 Token 中采样，与温度联合控制多样性。0 表示不启用",
      },
      llmCallTimeout: {
        label: "LLM 响应超时",
        desc: "单次 LLM 调用最长等待时间（秒），超时后自动重试，默认 120 秒",
        unit: "秒",
      },
      maxContextTokens: {
        label: "最大上下文 Token",
        desc: "Agent 对话窗口的 Token 上限，超出后自动压缩历史，默认 200000",
      },
      maxToolOutputChars: {
        label: "工具输出截断",
        desc: "单次工具调用返回的最大字符数，超出部分自动截断，默认 16000",
        unit: "字符",
      },
      parallelToolCalls: {
        label: "并行工具调用",
        desc: "Agent 发出多个独立工具请求时同步执行，减少总等待时间",
      },
    },
    allowedTools: {
      label: "允许的工具",
  ...
  organization: {
    title: "共享空间",
    subtitle: "创建或加入共享空间，与团队成员协作维护共享知识内容",
    createOrg: "新建空间",
    createOrgShort: "新建",
    joinOrg: "申请加入",
    joinOrgShort: "加入",
    ...
    invite: {
      ...
      confirmJoin: "确认加入",
      submitRequest: "申请加入",
      requireApprovalTip: "该空间需要空间负责人审核后才能加入",
      approvalLabel: "加入方式",
      needApproval: "需要审核",
      noApproval: "无需审核",
      ...
      requestSubmitted: "申请已提交，请等待空间负责人审核",
    ...
    noMembers: "暂无成员",
    roleUpdated: "空间权限已更新",
    roleUpdateFailed: "更新空间权限失败",
    memberRemoved: "成员已移除",
    memberRemoveFailed: "移除成员失败",
    empty: "您还没有加入任何共享空间",
    emptyDesc: "可以创建一个共享空间用于团队协作，或通过邀请码加入已有空间",
    all: "全部",
    createdByMe: "我创建的",
    joinedByMe: "我加入的",
    createdTag: "创建",
    ...
    emptyCreatedDesc: "可以先创建一个共享空间，把知识库共享给对应团队或部门",
    emptyJoined: "您还没有加入任何共享空间",
    emptyJoinedDesc: "请通过邀请码或空间搜索加入已有团队空间",
    role: {
      admin: "空间负责人",
      editor: "协作者",
      viewer: "只读成员",
    ...
    settings: {
      editTitle: "空间设置",
      detailTitle: "空间详情",
      myRoleDesc: "您在此空间中的协作权限决定了您的可操作范围",
      membersDesc: "查看和管理空间成员，调整成员空间权限",
      ...
      noSharedAgentsTip: "空间负责人可将智能体从智能体设置中共享到本空间",
      sharePermissionLabel: "空间权限",
      myPermissionLabel: "我的实际权限",
      permissionCalcFormula: "空间权限为共享时给该空间设定的权限；我的实际权限 = min(知识库共享权限, 我在本空间的权限)",
      permissionCalcTip: "我的实际权限 = min(知识库共享权限, 我在本空间的权限)。我在空间内是只读成员时，对此知识库最多只读；是协作者或空间负责人时，不超过知识库共享权限。",
      inviteMembers: "邀请成员",
      ...
      requireApprovalDesc: "开启后，新成员加入需要空间负责人审核",
      searchable: "开放可被搜索",
    ...
    editor: {
      navBasic: "基本信息",
      navPermissions: "空间权限说明",
      navJoin: "加入空间",
      basicTitle: "基本信息",
      basicDesc: "设置空间的名称和描述，便于成员识别",
      nameTip: "建议使用团队或项目名称，便于成员识别",
      descriptionTip: "描述空间的用途和目标，帮助成员了解空间",
      permissionsTitle: "空间内协作权限",
      permissionsDesc: "这里是共享空间内部的协作权限，不是平台角色；平台角色仍只有平台超级管理员和普通租户。",
      ...
      viewerPerm2: "编辑知识库内容",
      viewerPerm3: "管理空间设置",
      ownerNote: "作为空间创建者，您将自动成为空间负责人，拥有该空间内的完整协作权限。",
      joinTitle: "加入空间",
      joinDesc: "通过邀请码加入现有空间，获得知识库与智能体访问权限",
      joinIllustration: "输入空间负责人提供的邀请码即可加入",
      inviteCodeTip: "邀请码由空间负责人生成，请向他们索取",
    ...
    upgrade: {
      requestUpgrade: "申请空间权限升级",
      pending: "已提交申请",
      dialogTitle: "申请空间权限升级",
      currentRole: "当前空间权限",
      selectRole: "申请空间权限",
      reason: "申请理由（选填）",
      reasonPlaceholder: "请简要说明申请更高空间权限的原因...",
      submitSuccess: "空间权限升级申请已提交，等待空间负责人审核",
      submitFailed: "提交申请失败",
      upgradeRequest: "空间权限升级",
    },
    addMember: {
      button: "添加成员",
      dialogTitle: "添加成员",
  ...
  chatSurface: {
    searchLabel: "知识搜索",
    searchDesc: "直接检索知识片段和历史消息，不进入问答会话",
    trustedQaLabel: "可信问答",
    trustedQaDesc: "基于知识库和引用证据进行稳态问答",
    deepResearchLabel: "深度研究",
    deepResearchDesc: "使用多步推理、工具、网络搜索和记忆能力",
  },
  knowledgeSearch: {
    title: "知识搜索",
    subtitle: "在知识库和问答记录中进行语义检索，快速查找相关内容",
    tabKnowledge: "知识搜索",
    tabMessages: "消息搜索",
    placeholder: "输入搜索内容...",
    messagePlaceholder: "搜索历史问答消息...",
    searchBtn: "搜索",
    selectKb: "选择知识库",
    allKb: "全部知识库",
    noResults: "未找到相关结果",
    ...
    matchTypeKeyword: "关键词匹配",
    untitledSession: "未命名问答",
    matchCount: "条匹配",
    emptyHint: "输入关键词，在知识库中搜索相关内容片段",
    messageEmptyHint: "输入关键词，搜索历史问答消息",
    searching: "搜索中...",
    source: "来源",
    chunk: "个片段",
    expand: "展开",
  ...
  agentEditor: {
    ...
    desc: {
      ...
      topP: "核采样参数，限制模型只从累积概率前 P 的 Token 中采样，0 表示不限制",
      llmCallTimeout: "单次 LLM 调用的最长等待时间（秒），超时后自动重试",
      maxContextTokens: "Agent 对话上下文的最大 Token 数，超出后自动压缩历史消息",
      maxToolOutputChars: "工具调用返回内容的最大字符数，超出部分将被截断",
      parallelToolCalls: "当 Agent 发起多个独立工具调用时，并行执行以减少等待时间",
  ...
  datasource: {
    ...
    connectionFailed: "连接失败",
    isRequired: "为必填项",
    resourceHint: "选择要同步的资源范围",
    resourceLoadFailed: "加载资源列表失败",
    noResources: "未找到可同步资源",
    ...
    connectorDesc: {
      feishu: "同步飞书知识库中的文档、表格和文件",
      web_crawler: "通过 URL 列表或 Sitemap 抓取网页内容",
      rss: "从 RSS 或 Atom feed 同步文章内容",
    ...
    fieldHint: {
      pageUrls: "每行一个 URL，例如 https://example.com/docs",
      feedUrls: "每行一个 Feed URL，例如 https://example.com/feed.xml",
    },
    multilineHint: "每行输入一个 URL，也支持用逗号分隔",
    storageWarningTitle: "需要先配置存储引擎",
    storageWarningDesc: "当前知识库尚未选择存储引擎。请先完成存储配置，再创建或同步数据源。",
    storageRequired: "请先为当前知识库配置存储引擎，再创建或同步数据源。",
    summaryLabel: "数据范围",
    deletionModeLabel: "删除同步",
    deletionMode: {
      sync: "源内容删除后归档知识条目",
      ignore: "忽略源内容删除",
    },
    summary: {
      notConfigured: "尚未配置",
      resources: "已选择 {count} 个资源",
      rssFeeds: "{count} 个 Feed URL",
      webUrls: "{count} 个网页 URL",
      webSitemap: "已启用 Sitemap 抓取",
      webMixed: "{count} 个网页 URL + Sitemap",
    },
    issue: {
      config: "配置问题",
      sync: "同步问题",
    },
    latestRunDetails: "最近一次同步详情",
    showRunDetails: "展开最近同步",
    hideRunDetails: "收起最近同步",
    latestErrors: "最近错误",
    noRecentErrors: "最近无错误",
    manualActionRequired: "需要处理",
    manualAction: {
      storage: "知识库未配置存储引擎",
      feeds: "Feed 列表配置不完整",
      pages: "抓取范围配置不完整",
    ...
    manualHint: {
      storage: "先为当前知识库配置存储引擎，再重新发起同步。",
      feeds: "补充有效的 Feed URL，并重新测试连接。",
      pages: "补充页面 URL 或 Sitemap，然后重新测试连接。",
      auth: "检查源站凭证、权限范围或上游访问策略。",
      missing: "确认源地址仍然存在，并且当前环境可访问。",
      network: "稍后重试，或检查源站是否暂时不可用。",
      format: "上游返回内容不是有效的 Feed 或支持的页面格式。",
      config: "检查当前数据源字段配置，修正后再保存。",
      retry: "先打开同步日志查看具体错误，再决定是否重试。",
    },
    syncBlocked: {
      storage: "请先为知识库配置存储引擎，再执行同步。",
      feeds: "请先补全 Feed 列表，再执行同步。",
      pages: "请先补全抓取范围，再执行同步。",
      auth: "请先修复授权或权限问题，再执行同步。",
      format: "请先调整源地址或格式配置，再执行同步。",
      config: "请先修正数据源配置，再执行同步。",
    },
    fixBeforeSync: "先修配置",
    viewLogs: "查看日志",
    comingSoon: "即将支持",
    ...
    noResourcesDesc_web_crawler: "未找到可抓取的网页，请检查 URL 或 Sitemap 地址后重试。",
    noResourcesDesc_rss: "未找到 Feed 条目，请检查 Feed URL 后重试。",
    guideStep1_web_crawler: "填写一个或多个网页 URL，或提供 Sitemap 地址",
    guideStep2_web_crawler: "确保这些页面可以被服务器公网访问",
    guideStep3_web_crawler: "检查 URL 格式和站点可用性后再次重试",
    guideStep1_rss: "填写一个或多个有效的 RSS / Atom Feed URL",
    guideStep2_rss: "确保 Feed 可以公网访问且响应 XML",
    guideStep3_rss: "检查 Feed 地址或验证结果后再次重试",
    neverSynced: "未同步",
    justNow: "刚刚",
    minutesAgo: "{n} 分钟前",
    hoursAgo: "{n} 小时前",
